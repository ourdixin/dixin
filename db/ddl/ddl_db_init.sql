...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `buy_fee` float NOT NULL DEFAULT '0' COMMENT '产品认购费%',
  ...
  `manage_fee` float NOT NULL COMMENT '管理费',
  `open_day` varchar(256) NOT NULL COMMENT '开放日',
  `bonus` varchar(256) NOT NULL COMMENT '业绩提成',
  `sell_fee` varchar(256) NOT NULL COMMENT '退出费用',
