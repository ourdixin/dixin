...
<div class="cplb">
  ...
  <div class="cplb_zy">
    <ul>
      ...
      <li><fmt:formatDate pattern="yyyy-MM-dd" value="${purchase.product.valueDate}"/>起息日</li>
      <li><fmt:formatDate pattern="yyyy-MM-dd" value="${purchase.product.dueDate}"/>到期日</li>
    </ul>
  </div>
</div>
 </c:forEach>
