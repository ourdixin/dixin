  ...
  <table>
    <tbody>
      <tr>
        ...
        <td width="79%"><input maxlength="11" id="mobile" name="mobile" class="itstyle lt it log_user" type="text"  value="请输入手机号" onfocus="if(value==defaultValue){value='';this.style.color='#999'}" onblur="if(!value){value=defaultValue;this.style.color='#999'}" />          <div class="input-r-tips lt"></div></td>
      </tr>
      <tr>
        <td class="t">验证码：</td>
