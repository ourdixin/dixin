	...
	<div id="main_body">
		<div class="wrap">
			...
			<ul id="left_menu">
				...
				<dd><a href="<%=request.getContextPath()%>/admin/user.jsp"><img src="<%=request.getContextPath()%>/images/ico_07.png" width="20" height="20" />客户管理</a></dd>
				...
				<dd><a href="<%=request.getContextPath()%>/admin/assignment.jsp"><img src="<%=request.getContextPath()%>/images/ico_05.png" width="20" height="20" />客户产品转让</a></dd>
